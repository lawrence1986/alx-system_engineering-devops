...
-   Code Challenge Attempted by: Lawrence
-   Date: 10th July, 2023 
...
| -------- | ----------- |
| ` 0-first_9_tasks.jpg,0-first_9_tasks.png` |0. First 九 tasks.|
| ` 1-next_9_tasks.jpg,1-next_9_tasks.png` | 1. Reach חי completed tasks.|
| ` 2-next_9_tasks.jpg,2-next_9_tasks.png` | 2. Reach the perfect cube, 27|
